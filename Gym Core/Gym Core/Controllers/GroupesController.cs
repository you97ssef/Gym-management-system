...
namespace Gym_Core.Controllers
{
    public class GroupesController : Controller
    {
        ...
        public GroupesController(GymContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,NomGroupe,DescriptionGroupe")] Groupe groupe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomGroupe,DescriptionGroupe")] Groupe groupe)
        {
            if (id != groupe.Id)
            {
                return NotFound();
